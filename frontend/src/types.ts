...
export type ServerMessage =
  | { type: 'welcome'; playerId: string; playerName: string; playerCount?: number; queueSize?: number; onlineCount?: number; activeGames?: number; totalGamesPlayed?: number; totalPlayers?: number }
