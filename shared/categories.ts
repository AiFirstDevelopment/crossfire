...
const categoryWords: Record<string, string[]> = {
  ...
  // People / roles (non-job archetypes, characters, etc.)
  person: [
    "clown", // requested
    // additions like it
    "jester",
  ...
  // Health & medicine (non-body-part words)
  health: [
    "health",
    "illness",
    "disease",
  ...
  // Cooking verbs / techniques (more specific than action)
  cooking: [
    "bake",
    "boil",
    "steam",
  ...
  // Bathroom fixtures (distinct from room)
  bathroomFixture: [
    "toilet",
    "sink",
    "faucet",
  ...
  // Internet / social (more specific than technology)
  internet: [
    "account",
    "login",
    "logout",
  ...
  // Programming (more structured than "technology")
  programming: [
    "bug",
    "issue",
    "ticket",
  ...
  // Art supplies (distinct from reading/writing)
  art: [
    "paint",
    "brush",
    "canvas",
  ...
  // Music genres / performance terms (extends music)
  musicTerm: [
    "concert",
    "gig",
    "rehearsal",
  ...
  // Religion / spirituality (you’ve asked for scripture stuff before)
  religion: [
    "bible",
    "scripture",
    "verse",
  ...
  // Home maintenance (distinct from generic tool)
  maintenance: [
    "repair",
    "fix",
    "replace",
